...
//           <span className="sr-only">Dementia Testing</span>
//         </Link>
...
//                 Our online dementia assessment helps you identify potential cognitive issues faster and earlier. Get started with a simple test today.
//               </p>
//               <button
//                 onClick={openModal}
...
//         </section>
//       </main>
//       <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-[hsl(210_40%_80%)]">
